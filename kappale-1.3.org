...
** Vinkkejä
   ...
   - rekursiivinen prosessi lasketaan ylhäältä alaspäin (ensin \(\frac{N_1}{D_1}\))
   - iteratiivinen prosessi lasketaan alhaalta ylöspäin (ensimmäinen
     tulos on \(\frac{N_k}{D_k}.\)
** Ratkaisu
